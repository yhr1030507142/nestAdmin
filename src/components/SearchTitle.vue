  ...
  <div class="search">
    <div class="item">
      <el-button-group>
        ...
        <el-button @click="setType(1)" :type="active === 1 ? 'primary' : ''">7日</el-button>
        <el-button @click="setType(2)" :type="active === 2 ? 'primary' : ''">30日</el-button>
  ...
  methods: {
    ...
    setType(type) {
      ...
      if (type === 0) {
        ...
        const weekStart = dayjs().subtract(6, 'days').format('YYYY-MM-DD')
